...
wap_tms.eloqua.wdl.baseUrl = ('https:' == window.location.protocol ? 'https' : 'http') + '://s'+wap_tms.eloqua.wdl.eloquaSiteId+'.t.eloqua.com/visitor/v200/svrGP.aspx?pps=';
...
if(wap_tms.jquery.ver_1_7_plus){(function($){
  $.ajax({
                ...
                success: function () {                        
                  if (typeof GetElqContentPersonalizationValue == "function") {
						wap_tms.eloqua.wdl.erpmId = GetElqContentPersonalizationValue('Intel_ERPM_ID1');
						if(wap_tms.cookie.RC("utag_main").wa_erpm_id == undefined && utag_data.wa_erpm_id == undefined){
							utag_data.wa_erpm_id = wap_tms.eloqua.wdl.erpmId;
							utag.loader.SC("utag_main", {
								"wa_erpm_id": wap_tms.eloqua.wdl.erpmId
							});
						}
...
//tealium universal tag - utag.sender.custom_container ut4.0.201805222154, Copyright 2018 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
