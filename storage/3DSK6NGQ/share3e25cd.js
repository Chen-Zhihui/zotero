...
for(var m=p.isIOS&&1==window._copyright_stat&&1==window.is_need_reward,w=0,c=0,g=s.length;g>c;c++){
var l=s[c],u=l.getAttribute("data-src")||l.getAttribute("src"),f=l.getAttribute("data-type");
if(u&&!u.isGif()&&0!=u.indexOf("data:")){
for(;-1!=u.indexOf("?tp=webp");)u=u.replace("?tp=webp","");
l.dataset&&l.dataset.s&&u.isCDN()&&(u=u.replace(/\/640$/,"/0"),u=u.replace(/\/640\?/,"/0?")),
u.isCDN()&&(u=r.addParam(u,"wxfrom","3",!0)),u=e.is_https_res?u.http2https():u.https2http(),
f&&(u=r.addParam(u,"wxtype",f,!0)),a.push(u),"1"!=l.getAttribute("data-nopreviewclick")&&!function(e){
o.on(l,"click",function(o){
...
var d=window.getComputedStyle(n,null),p=parseInt(d.getPropertyValue("opacity")),c=d.getPropertyValue("visibility");
if(1!=p||"visible"!=c){
s=!1;
break;
}
var g=n.getBoundingClientRect();
if(("hidden"==d.overflow||"hidden"==d.overflowX||"hidden"==d.overflowY)&&(g.left>r.left||g.right<r.right||g.top>r.top||g.bottom<r.bottom)){
s=!1;
break;
}
n=n.parentElement;
...
var l=new Image,u="https://badjs.weixinbridge.com/badjs?id=168&level=4&from="+encodeURIComponent(location.href)+"&msg="+encodeURIComponent(e);
l.src=u.slice(0,1024);
}
return!1;
}
}
t(e,a),m&&0==w&&i(o.target.src,2);
}
});
}(u),l.removeAttribute("data-nopreviewclick");
}
}
if(m){
...
Math.abs(t-b)>10&&Math.abs(i-v)>10&&(w=0);
}),o.on(_,"touchend",function(e){
0!=w&&(+new Date-w>800&&+new Date-w<6e3?i(e.target.src,1):w=0);
});
}
}
