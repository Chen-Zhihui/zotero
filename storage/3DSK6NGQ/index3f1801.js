...
e.offsetTop<i?(t=!0,w.off(window,"scroll",o),(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=59977_15_1",
f.hotspotReport({
...
{
var q=!l.isWp&&-1==navigator.userAgent.indexOf("MicroMessenger");
-1!=navigator.userAgent.indexOf("WindowsWechat");
}
e("appmsg/share.js");
var R=u(1e3*parseInt(top.window.modify_time)),B=R.format("YYYY-MM-DD"),z=document.getElementById("js_modify_time");
...
d&&(d.isCDN()&&(d=d.imgChange640(),t&&(d=E.addParam(d,"tp","webp",!0)),d=E.addParam(d,"wxfrom","5",!0),
is_https_res||A?d=d.http2https():("http:"==location.protocol||-1!=navigator.userAgent.indexOf("MicroMessenger"))&&(d=d.https2http())),
setTimeout(function(){
a.onload=function(){
...
var c=e("biz_wap/ui/lazyload_img.js"),m=1;
window.logs.outer_pic=0;
for(var l=document.getElementsByTagName("img"),g=0,_=l.length;_>g;g++){
{
var u=l[g].getAttribute("data-src");
l[g].getAttribute("src");
}
u&&u.isGif()&&l[g].className.indexOf("__bg_gif")<0&&(l[g].className+=" __bg_gif"),
u&&o(l[g]);
}
for(var f=document.getElementsByClassName("__bg_gif"),g=0,_=f.length;_>g;++g)f[g].setAttribute("data-order",g);
var h=function(e){
try{
var t=e,o=t.getAttribute("data-src");
if(null==o.match(/^https\:\/\/mmbiz\.qpic\.cn/)&&null==o.match(/^http\:\/\/mmbiz\.qpic\.cn/))return;
var n=t.parentNode;
if(r.hasClass(n,"js_jump_icon"))return;
...
if(!i)return;
var s=document.createElement("span"),d=getComputedStyle(t);
"static"!=d.positon&&(s.style.position=d.positon),s.style.left=d.left,s.style.top=d.top,
s.style.right=d.right,s.style.bottom=d.bottom,s.style.margin=d.margin,r.addClass(s,"js_jump_icon"),
r.addClass(s,"h5_image_link"),t.style.position="static",t.style.margin="0px",t.parentNode.insertBefore(s,t),
s.appendChild(t),window.__addIdKeyReport("111535",0);
}catch(c){}
},y=function(e){
try{
...
for(var n=0;n<t.length;n++)"a"!=t[n].tagName.toLowerCase()&&y(t[n]);
}catch(i){}
};
try{
for(var v=document.getElementsByTagName("a"),j=0;j<v.length;j++){
var I=v.item(j),x=I.getAttribute("href")||"";
...
var m=1e3,l=window.user_uin||0,g=0!==l&&Math.floor(l/100)%1e3<m;
g&&(n>=43305||d>=16)&&o.isGif()?(o=E.addParam(o,"tp","wxpic",!0),window.__addIdKeyReport("28307",91)):window.webp&&(o=E.addParam(o,"tp","webp",!0),
...
/tp\=webp/.test(e)&&(p=11);
var l=new Image;
l.src="http://mp.weixin.qq.com/mp/jsreport?key="+p+"&content="+(encodeURIComponent(e)+"["+uin+"]")+"&r="+Math.random();
}
},
onload:function(e,t){
...
if(N){
var L="";
w.on(N,"click",function(){
return r.hasClass(N,"rich_media_meta_link")?window.is_temp_url?(n("预览状态下不能操作"),!1):N.getAttribute("data-rewardsn")?1!=N.getAttribute("data-canreward")?!1:(L="https://mp.weixin.qq.com/mp/author?action=show&author_id="+author_id+"&rewardsn="+N.getAttribute("data-rewardsn")+"&timestamp="+N.getAttribute("data-timestamp")+"&__biz="+window.biz+"&appmsgid="+window.appmsgid+"&idx="+window.idx+"&scene=142&rscene=129#wechat_redirect",
...
-1==e.err_msg.indexOf("ok")&&(location.href=L);
})):location.href=L,!1)):!1:!1;
});
}
}catch(h){}
...
}),m(),g(),w.tap(document.getElementById("js_hotspot_area"),function(e){
...
w.on(d,"click",c),w.on(a,"click",c),w.on(document,"click",function(e){
